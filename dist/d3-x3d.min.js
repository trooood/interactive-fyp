;(function (global, factory) {
  ...
  var d3__namespace = _interopNamespaceDefault(d3)
  var version$1 = '2.1.5'
  var license$1 = 'GPL-2.0'
  var packageJson = { version: version$1, license: license$1 }
  ...
  function fromCurve (values, curveFunction, epsilon = 1e-5, samples = 100) {
  ...
  function dataTransform (data) {
    ...
    var stack = function stack () {
      ...
      data.values.forEach(function (d, i) {
        y1 = y0 + d.value
        values[i] = { key: d.key, value: d.value, y0: y0, y1: y1 }
        y0 += d.value
      })
      return { key: data.key, values: values }
    }
    var rotate = function rotate () {
      ...
      var rotated = rowKeys.map(function (rowKey, rowIndex) {
        ...
        return { key: rowKey, values: values }
      })
      return rotated
    }
    var smooth = function smooth (curveFunction) {
      ...
      var smoothed = {
        ...
        values: sampler.map(function (t) {
          return { key: keyPolator(t), value: valuePolator(t) }
        })
      }
      return smoothed
    }
    return { summary: summary, rotate: rotate, stacked: stack, smooth: smooth }
  }
  var colorNames = {
    aliceblue: '#f0f8ff',
    antiquewhite: '#faebd7',
  ...
  function colorParse (color) {
    ...
    if (color.substr && color.substr(0, 1) === '#') {
      ...
      var len = hex.length
      if (len === 8) {
        red = parseInt('0x' + hex.substr(0, 2), 16) / 255
        green = parseInt('0x' + hex.substr(2, 2), 16) / 255
        blue = parseInt('0x' + hex.substr(4, 2), 16) / 255
        parseInt('0x' + hex.substr(6, 2), 16) / 255
      } else if (len === 6) {
        red = parseInt('0x' + hex.substr(0, 2), 16) / 255
        green = parseInt('0x' + hex.substr(2, 2), 16) / 255
        blue = parseInt('0x' + hex.substr(4, 2), 16) / 255
      } else if (len === 4) {
        red = parseInt('0x' + hex.substr(0, 1), 16) / 15
        green = parseInt('0x' + hex.substr(1, 1), 16) / 15
        blue = parseInt('0x' + hex.substr(2, 1), 16) / 15
        parseInt('0x' + hex.substr(3, 1), 16) / 15
      } else if (len === 3) {
        red = parseInt('0x' + hex.substr(0, 1), 16) / 15
        green = parseInt('0x' + hex.substr(1, 1), 16) / 15
        blue = parseInt('0x' + hex.substr(2, 1), 16) / 15
  ...
  var colorHelper = Object.freeze({ __proto__: null, colorParse: colorParse })
  ...
  function componentAxis () {
    ...
    var getAxisDirectionVector = function getAxisDirectionVector (axisDir) {
      var axisDirectionVectors = { x: [1, 0, 0], y: [0, 1, 0], z: [0, 0, 1] }
  ...
  function componentCrosshair () {
    ...
    var my = function my (selection) {
      selection.each(function (data) {
        ...
        dimensions.x = xScale
          ? Math.max.apply(Math, _toConsumableArray(xScale.range()))
          : dimensions.x
        dimensions.y = yScale
          ? Math.max.apply(Math, _toConsumableArray(yScale.range()))
          : dimensions.y
        dimensions.z = zScale
          ? Math.max.apply(Math, _toConsumableArray(zScale.range()))
          : dimensions.z
        ...
        var ball = ballSelect
          ...
          .attr(
            'translation',
            ''.concat(xVal, ' ').concat(yVal, ' ').concat(zVal)
          )
          .classed('ball', true)
          .append('Shape')
        ball
  ...
  function componentDonut () {
    ...
    var my = function my (selection) {
      selection.each(function (data) {
        ...
        var sectors = element.selectAll('.sector').data(
          function (d) {
        ...
        var sectorsEnter = sectors
          .enter()
          .append('Transform')
          .classed('sector', true)
          .call(shape)
          .merge(sectors)
        var sectorsTransition = sectorsEnter
          .transition()
          .duration(300)
    ...
    var my = function my (selection) {
      selection.each(function (data) {
        ...
        var colorScale = d3__namespace
          ...
          .domain(Object.keys(dimensions))
          .range(colors)
        var planeSelect = element
          .selectAll('.plane')
          .data(Object.keys(dimensions))
        var plane = planeSelect
          .enter()
          .append('Transform')
          .classed('plane', true)
          .attr('translation', function (d) {
  ...
  function componentSpots () {
    ...
    var my = function my (selection) {
      selection.each(function (data) {
        ...
        var spots = element.selectAll('.spot').data(
          function (d) {
            return d.values
          },
          function (d) {
    ...
    var my = function my (selection) {
      selection.each(function (data) {
        ...
        spotGroupEnter.each(function (plane, i, nodes) {
          ...
          var spotSeries = el
            .selectAll('.spotSeries')
            .data(spotData(data), function (d) {
              return d.key
            })
          spotSeries
            .enter()
        ...
        var vectorData = function vectorData (d) {
          return d.values
            .map(function (f) {
              ...
              f.translation =
                xScale(f.x) + ' ' + yScale(f.y) + ' ' + zScale(f.z)
              f.value = vecLen
              f.rotation = []
  ...
  function componentViewpoint () {
    var centerOfRotation = [0, 0, 0]
    var viewPosition = [80, 15, 80]
    var viewOrientation = [0, 1, 0, 0.8]
    var fieldOfView = 0.8
    var my = function my (selection) {
      selection.each(function () {
    ...
    my.quickView = function (view) {
      switch (view) {
        case 'left':
          ...
          break
        case 'side':
          centerOfRotation = [20, 0, 0]
          viewPosition = [20, 20, 50]
          viewOrientation = [0, 0, 0, 0]
          fieldOfView = 1
          break
        case 'top':
          centerOfRotation = [0, 0, 0]
        ...
        default:
          centerOfRotation = [0, 0, 0]
          viewPosition = [80, 15, 80]
          viewOrientation = [0, 1, 0, 0.8]
          fieldOfView = 0.8
      }
      return my
    }
  ...
  function buildProtos (scene) {
    var proto = scene
      .append('ExternProtoDeclare')
      .attr('name', 'Torus')
      .attr('url', '"'.concat(torus, '"'))
    proto
      .append('field')
      ...
      selection.each(function (data) {
        ...
        bubbles
          ...
          .on('d3X3dMouseOver', function (e) {
            ...
            var d = { x: xVal, y: yVal, z: zVal, key: datum.key }
            scene
              .select('.label')
              .datum(d)
              .each(function () {
  ...
  function dataset5 () {
    ...
    return d3__namespace.range(nx).map(function (i) {
      var values = d3__namespace.range(nz).map(function (j) {
        return { key: j, value: f(xRange[i], zRange[j]) }
      })
      return { key: i, values: values }
    })
  }
